...
open class ACKeychainSwift {
    ...
    /// Instantiate a ACKeychainSwift object
    public init() { }
    ...
    open func set(_ value: String, forKey key: String,
                  withAccess access: ACKeychainSwiftAccessOptions? = nil) -> Bool {
    ...
    open func set(_ value: Data, forKey key: String,
        ...
        let accessible = access?.value ?? ACKeychainSwiftAccessOptions.defaultOption.value
        
        let prefixedKey = keyWithPrefix(key)
        
        var query: [String: Any] = [
            ACKeychainSwiftConstants.klass: kSecClassGenericPassword,
            ACKeychainSwiftConstants.attrAccount: prefixedKey,
            ACKeychainSwiftConstants.valueData: value,
            ACKeychainSwiftConstants.accessible: accessible
        ]
    ...
    open func getData(_ key: String, asReference: Bool = false) -> Data? {
        ...
        var query: [String: Any] = [
            ACKeychainSwiftConstants.klass: kSecClassGenericPassword,
            ACKeychainSwiftConstants.attrAccount: prefixedKey,
            ACKeychainSwiftConstants.matchLimit: kSecMatchLimitOne
        ]
        
        if asReference {
            query[ACKeychainSwiftConstants.returnReference] = kCFBooleanTrue
        } else {
            query[ACKeychainSwiftConstants.returnData] =  kCFBooleanTrue
        }
    ...
    func addAccessGroupWhenPresent(_ items: [String: Any]) -> [String: Any] {
        ...
        result[ACKeychainSwiftConstants.accessGroup] = accessGroup
        return result
    }
    ...
    func addSynchronizableIfRequired(_ items: [String: Any], addingItems: Bool) -> [String: Any] {
        ...
        var result: [String: Any] = items
        result[ACKeychainSwiftConstants.attrSynchronizable] = addingItems == true ? true : kSecAttrSynchronizableAny
        return result
    }
}
